...
- [Commit memory by design](feedback_commit_memory_by_design.md) — `.claude/memory/` is in the repo and tracked; commit memory edits as part of the work without being asked. Committing is authorized; **pushing is still gated** by the hard rule.
