...
- [Mark Baliff purged from production 2026-09-01](project_mark_baliff_purge.md) — test user's 748 rows reassigned to the owner (not deleted; his splits sat on $3,740 of real revenue). Explains the owner's ~94 splits.
