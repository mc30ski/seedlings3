...
// Clerk multi-domain configuration lives in src/lib/clerkDomains.ts so
// the sign-in page can share the same primary/satellite hostname list.
// See that module for the full explanation of the satellite flow.
