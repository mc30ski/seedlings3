  ...
  return (
    <input
      ...
      style={{
        ...
        background: disabled ? "var(--chakra-colors-bg-muted, var(--chakra-colors-gray-subtle))" : "var(--chakra-colors-bg)",
        color: disabled ? "var(--chakra-colors-fg-muted, var(--chakra-colors-gray-fg))" : "var(--chakra-colors-fg)",
