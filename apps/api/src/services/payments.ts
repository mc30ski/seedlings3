...
// ────────────────────────────────────────────────────────────────────
// Payment breakdown math — moved to lib/payoutMath.ts so the forecasting
// tool computes payouts with the same code that writes them. Re-exported
// here because every existing caller (and the payments build gate) imports
...
export { type FinalSplitRow } from "../lib/payoutMath";
import {
  computeBreakdown,
  reconcileApproval,
  allocateExact,
